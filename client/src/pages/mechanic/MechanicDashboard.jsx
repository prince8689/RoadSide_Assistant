  ...
  return (
    <div className="min-h-screen bg-light">
      <nav className="bg-dark p-4 flex justify-between items-center text-white">
        <div className="text-xl font-bold text-primary">RoadAssist <span className="text-sm text-muted">Mechanic</span></div>
      ...
      <div className="flex flex-col items-center justify-center h-[80vh]">
        <h1 className="text-4xl font-bold text-primary mb-4">Mechanic Dashboard</h1>
